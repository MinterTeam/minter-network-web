...
Для авторизации в кошельке, введите ранее полученную seed-фразу. Т.к. любая кастомная монета в сети Minter обеспечена базовой монетой BIP, вам необходимо пополнить свой адрес монетой BIP. [Купить BIP](https://www.minter.network/ru/docs/buy-sell-bip) можно на биржах или в обменниках.
