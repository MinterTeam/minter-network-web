...
### Локальные монеты
Могут быть использованы и несут ценность только в вашей экосистеме, платформе, сообществе. Они не обладают ликвидностью, способностью обмениваться на другие монеты и рыночной ценой. Технически, для этих монет доступен только один [вид транзакций](https://www.minter.network/docs#transactions) - `Send` (то есть отправка с одного адреса на другой).
...
## Создание монеты
Любая кастомная монета в сети Minter обеспечена нативной монетой BIP. Создавая монету, вы резервируете необходимое количество BIP, а также уплачиваете комиссию сети за тикер:
...
Для авторизации в кошельке, введите ранее полученную seed-фразу. Т.к. любая кастомная монета в сети Minter обеспечена нативной монетой BIP, вам необходимо пополнить свой адрес монетой BIP. Купить ее можно на биржах или в обменниках, воспользуйтесь мониторингом [BipChange](https://bipchange.org/).
...
Необходимо отметить, что для интеграции программы лояльности или наград в вашу платформу, вам потребуется программист (если вы сами им не являетесь). Кейсы имплементации вы можете найти в [этой стать](https://medium.com/@MinterTeam/%D1%80%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%BE-%D0%BF%D0%BE-%D0%B8%D0%BD%D1%82%D0%B5%D0%B3%D1%80%D0%B0%D1%86%D0%B8%D0%B8-minter-%D0%B2-%D0%B2%D0%B0%D1%88-%D0%B1%D0%B8%D0%B7%D0%BD%D0%B5%D1%81-ea75e28b53ad). Среди них:
1. Прием BIP/вашей монеты в качестве оплаты за товары и услуги
2. Выплата кэшбека в вашей монете
3. Доступ к ресурсам
4. Рейтинг пользователей

С пример построения программы лояльности за день на примере Twitter можно ознакомиться в [этой статье](https://medium.com/@danillashin/%D0%BF%D1%80%D0%BE%D0%B3%D1%80%D0%B0%D0%BC%D0%BC%D0%B0-%D0%BB%D0%BE%D1%8F%D0%BB%D1%8C%D0%BD%D0%BE%D1%81%D1%82%D0%B8-%D0%B7%D0%B0-%D0%B4%D0%B5%D0%BD%D1%8C-1526c96005bd).

## Перевыпуск монет при сохранении тикера
Перевыпуск монет при сохранении старого тикера может быть необходим для повторного использования монет, например, если ваша система наград или программа лояльности предполагает одноразовое использование монет:
